...
// AddFromReader provides a mock function with given fields: reader, cell, prop, extension
func (_m *Image) AddFromReader(reader io.Reader, cell internal.Cell, prop props.Rect, extension consts.Extension) error {
	ret := _m.Called(reader, cell, prop, extension)

	var r0 error
	if rf, ok := ret.Get(0).(func(io.Reader, internal.Cell, props.Rect, consts.Extension) error); ok {
		r0 = rf(reader, cell, prop, extension)
	} else {
		r0 = ret.Error(0)
	}
